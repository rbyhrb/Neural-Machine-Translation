...
class Transformer_bpe(nn.Module):
...
SAVE_NAME = 'transformer_bpe.pkl'

input_lang, output_lang, pairs, test_pairs = readLangs('iwslt16_en_de/train.en', 'iwslt16_en_de/train.de', 'iwslt16_en_de/dev.en', 'iwslt16_en_de/dev.de', 'en', 'de', vocab_size1, vocab_size2, reverse=False)
#pairs = pairs[0:10]
...
model = Transformer_bpe(input_lang.size, output_lang.size, n_hidden, n_layers, n_heads, dropout_p, MAX_LENGTH, n_ff_hidden).to(DEVICE)
